 ...
 */
define('STATE_SQL_ENGINE', getenv('ZPUSH_STATE_SQL_ENGINE') ?: 'mysql');
define('STATE_SQL_SERVER', getenv('ZPUSH_STATE_SQL_SERVER') ?: 'localhost');
define('STATE_SQL_PORT', getenv('ZPUSH_STATE_SQL_PORT') ?: '3306');
define('STATE_SQL_DATABASE', getenv('ZPUSH_STATE_SQL_DATABASE') ?: 'zpush');
define('STATE_SQL_USER', getenv('ZPUSH_STATE_SQL_USER') ?: 'root');
define('STATE_SQL_PASSWORD', getenv('ZPUSH_STATE_SQL_PASSWORD') ?: '');
